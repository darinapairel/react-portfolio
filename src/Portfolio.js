            ...
            <div className={`${this.props.classes.grid}`}>
              <Grid className={this.props.classes.gridContent} container spacing={16}  direction="column" justify="space-between">
                  <Grid className={"home"} id="home" container spacing={16}  direction="row" justify="space-between">
                      <Grid item xs={6}>
                            <Typography className={this.props.classes.portfolio_home} variant="h6">Hello</Typography>
                                <Typography className={`${this.props.classes.portfolio_home} home__info`} variant="body2">
                  ...
                  <Grid item xs={12}>
                    <section className={"about"} id="about">
                        <Typography className={this.props.classes.portfolio_home} variant="h6">About</Typography>
                        <div className={`about__info ${this.props.classes.flexRow} ${this.props.classes.flex} ${this.props.classes.flexSpaceBetween}`}>
                            <Typography className={`${this.props.classes.portfolio_home} repos`} variant="body2">
                                Список репозиториев на GitHub:
                                {this.renderRepos(this.props.github.gitRepos)}
                            </Typography>
                            <Typography className={`${this.props.classes.portfolio_home} bio`} variant="body2">
                  ...
                  <Grid item xs={12}>
                    <section id="contact">
                        <Typography className={this.props.classes.portfolio_home} variant="h6">Contact</Typography>
                    </section>
                  </Grid>
              </Grid>
            </div>
